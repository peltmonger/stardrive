...
Explore all different articles for variations in the frontmatter, which illustrate fallbacks and variations. Have a look at the `./src/content.config.ts` for more details on the different options.
